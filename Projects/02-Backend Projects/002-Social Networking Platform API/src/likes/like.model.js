...
let likes = [
  new LikeModel(1, 1, 1),
  new LikeModel(7, 1, 2),
  new LikeModel(13, 1, 3),
  new LikeModel(2, 2, 1),
  new LikeModel(8, 2, 2),
  new LikeModel(14, 2, 3),
  new LikeModel(3, 3, 1),
  new LikeModel(9, 3, 2),
  new LikeModel(15, 3, 3),
  new LikeModel(4, 4, 1),
  new LikeModel(10, 4, 2),
  new LikeModel(16, 4, 3),
  new LikeModel(5, 5, 1),
  new LikeModel(11, 5, 2),
  new LikeModel(17, 5, 3),
  new LikeModel(6, 6, 1),
  new LikeModel(12, 6, 2),
  new LikeModel(18, 6, 3),
];
