...
export default class CommentController{
    ...
    static createComment(req,res,next){
        ...
        const comments = CommentModel.add(req.params.postId, req.payload.userId, req.body.content);
    ...
    static updateComment(req,res,next){
        ...
        const comments = CommentModel.update(req.params.commentId, req.body.content);
        if(!comments){
            throw new ApplicationError(404,"No comment found...!")
        }
