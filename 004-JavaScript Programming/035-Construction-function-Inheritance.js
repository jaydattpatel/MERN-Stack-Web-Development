...
Car.prototype.getDetails = function () {
  console.log(
    `The ${this.color} ${this.name} is of ${this.brand} company. It has seating for ${this.seats} people`
  );
};
...
function Book(name, pages, price) {
  ...
  this.bookInfo = function () {
    console.log(
      `name: ${this.name}, pages: ${this.pages}, price: ${this.price}`
    );
  };
}
...
let book1 = new Motivation_Books(
  "XYZ",
  200,
  "1500 INR",
  "Mr.Author",
